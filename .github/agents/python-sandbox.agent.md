---
name: Python Sandbox
description: Execute Python code in a secure Podman container with access to MCP servers for weather, sports, stocks, fx, wikipedia, msforms, browser, countries, openlibrary, hackernews, and more.
...
- `servers` (optional): MCP servers to load, e.g., `['weather', 'sports', 'stocks', 'fx', 'wikipedia', 'msforms', 'browser', 'countries', 'openlibrary', 'hackernews']`. Omit for plain Python.
